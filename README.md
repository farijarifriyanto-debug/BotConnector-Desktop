...
```powershell
npx https://app.botconnector.id/device-cli-v0.4.1.tgz connect
```
...
```powershell
npx https://app.botconnector.id/device-cli-v0.4.1.tgz connect --code ABC123 --allow-desktop-commander
```
...
BotConnector Device CLI v0.4.1 can serve a self-contained local browser UI on
...
```powershell
npx https://app.botconnector.id/device-cli-v0.4.1.tgz connect --code <PAIR_CODE> --allow-local-ai
```
